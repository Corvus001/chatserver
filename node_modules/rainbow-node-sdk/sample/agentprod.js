...
/*
    ...
    .then( (_bubble) => {
      ...
      .then( (_contact) => {
        contact = _contact;
      return rainbowSDK.bubbles.inviteContactToBubble( contact, bubble, false, false);
    })
    .then( (_bubble) => {
      return new Promise( (resolve) => {
        setTimeout(() => {
        resolve(rainbowSDK.bubbles.promoteContactInBubble( contact , _bubble, true));
      }, 5000);
      });
    })
    .then((_bubble) => {
      console.log(JSON.stringify(_bubble));
      return new Promise( (resolve) => {
        setTimeout(() => {
        resolve(rainbowSDK.bubbles.promoteContactInBubble( contact , _bubble, false));
      }, 5000);
      });
    })
    .then((_bubble) => {
    ...
    .then( (_bubble) => {
      return new Promise( (resolve) => {
        setTimeout(() => {
        resolve(rainbowSDK.bubbles.changeBubbleOwner( _bubble  , contact));
      }, 5000);
      });
    })
